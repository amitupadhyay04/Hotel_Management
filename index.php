       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">      
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              <h4 id="about"><strong style="color: #ffbb2b ">About</strong></h4><br>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              <h4 id="contact us"><strong>Contact Us</strong></h4><hr>
              Address : Noida,Uttar pradesh<br>
              Mail : comforthotelservices@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                Ajit Kumar ||Amit kumar<br>
                Lakshya Agarwal || Lakshya Jindal<br>
                Mansi <br>
            </div>
        </div>
